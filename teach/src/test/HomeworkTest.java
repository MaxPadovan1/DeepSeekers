...
class HomeworkTest {
    ...
    void constructorAndGetters() {
        Homework h = new Homework("H1", "SUB2", "Read Chapter", "Read chapters 3–5", "2025-06-01","2025-05-01","2025-05-20");
        ...
        assertEquals("2025-05-01",h.getOpenDate());
        assertEquals("2025-05-20",h.getOpenDate());
    }
}
